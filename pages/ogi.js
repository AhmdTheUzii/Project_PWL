          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: '#d1d5db' }}>
                Portfolio <span style={{ color: '#fb923c' }}>Ahmad Fauzi</span>
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  Saya adalah seorang backend developer yang fokus pada pengembangan sistem yang robust dan scalable. 
                  Memiliki pengalaman dalam administrasi sistem dan database management.
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  ...
                  Aktif dalam berbagai proyek backend dan sistem administrasi.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '24px' }}>
                  <div style={{
                    ...
                    <i className="fas fa-server" style={{ color: 'white', fontSize: '20px' }}></i>
                  </div>
                  <h3 style={{ fontSize: '24px', fontWeight: '600', color: 'white' }}>
                    Skills
                  </h3>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                  {['Backend: Node.js, PHP, Python', 'Database: MySQL, PostgreSQL', 'DevOps: Docker, Linux', 'API Development', 'System Administration'].map(skill => (
                    <div key={skill} style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="mailto:ahmad@example.com" style={{
                backgroundColor: '#f97316',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '8px',
              ...
              <a href="https://github.com/ahmad" target="_blank" style={{
              ...
              <a href="https://linkedin.com/in/ahmad" target="_blank" style={{
