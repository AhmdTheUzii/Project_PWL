...
export default function Hasan() {
  return (
    <>
      <Head>
        <title>Nur Hasan - Portfolio</title>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: '#d1d5db' }}>
                Portfolio <span style={{ color: '#fb923c' }}>Nur Hasan</span>
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  Saya adalah seorang DevOps engineer yang passionate dalam mengoptimalkan proses deployment dan infrastructure. 
                  Memiliki pengalaman dalam cloud computing dan automation.
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  ...
                  Aktif dalam berbagai proyek DevOps dan cloud infrastructure.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '24px' }}>
                  <div style={{
                    ...
                    <i className="fas fa-cloud" style={{ color: 'white', fontSize: '20px' }}></i>
                  </div>
                  <h3 style={{ fontSize: '24px', fontWeight: '600', color: 'white' }}>
                    Skills
                  </h3>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                  {['AWS', 'Azure', 'GCP', 'Docker', 'Kubernetes', 'CI/CD Pipelines', 'Linux Administration', 'Infrastructure as Code'].map(skill => (
                    <div key={skill} style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="mailto:nur.hasan@example.com" style={{
                backgroundColor: '#f97316',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '8px',
              ...
              <a href="https://github.com/nurhasan" target="_blank" style={{
              ...
              <a href="https://linkedin.com/in/nurhasan" target="_blank" style={{
