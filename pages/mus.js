...
export default function Mus() {
  return (
    <>
      <Head>
        <title>Nurul Mustofa - Portfolio</title>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: '#d1d5db' }}>
                Portfolio <span style={{ color: '#fb923c' }}>Nurul Mustofa</span>
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  Saya adalah seorang data analyst yang passionate dalam menganalisis data dan menciptakan insights yang berharga. 
                  Juga memiliki keahlian dalam machine learning dan artificial intelligence.
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  ...
                  Aktif dalam berbagai proyek data science dan machine learning.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                  {['Python', 'R', 'SQL', 'Machine Learning', 'Data Visualization', 'Statistical Analysis', 'Deep Learning'].map(skill => (
                    <div key={skill} style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="mailto:nurul.mustofa@example.com" style={{
                backgroundColor: '#f97316',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '8px',
              ...
              <a href="https://github.com/nurulmustofa" target="_blank" style={{
              ...
              <a href="https://linkedin.com/in/nurulmustofa" target="_blank" style={{
