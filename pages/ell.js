...
export default function Ell() {
  return (
    <>
      <Head>
        <title>Nurul Laylatul - Portfolio</title>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: '#d1d5db' }}>
                Portfolio <span style={{ color: '#fb923c' }}>Nurul Laylatul</span>
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  Saya adalah seorang frontend developer yang passionate dalam menciptakan user interface yang menarik dan responsif. 
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  ...
                  Aktif mengikuti berbagai workshop dan bootcamp frontend development.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                  {['HTML', 'CSS', 'JavaScript', 'React', 'Vue.js', 'Bootstrap', 'Tailwind', 'UI/UX Design', 'Responsive Design'].map(skill => (
                    <div key={skill} style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="mailto:nurul@example.com" style={{
                backgroundColor: '#f97316',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '8px',
              ...
              <a href="https://github.com/nurul" target="_blank" style={{
              ...
              <a href="https://linkedin.com/in/nurul" target="_blank" style={{
