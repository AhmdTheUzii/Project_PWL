...
export default function Angger() {
  return (
    <>
      <Head>
        <title>Angger Budianto - Portfolio</title>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: '#d1d5db' }}>
                Portfolio <span style={{ color: '#fb923c' }}>Angger Budianto</span>
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  Saya adalah seorang mobile developer yang passionate dalam menciptakan aplikasi mobile yang user-friendly. 
                  Juga memiliki keahlian dalam UI/UX design untuk mobile platforms.
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{ color: '#d1d5db', lineHeight: '1.7', fontSize: '16px' }}>
                  ...
                  Aktif dalam berbagai proyek mobile development dan UI/UX design.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                  {['React Native', 'Flutter', 'iOS & Android Development', 'UI/UX Design', 'Figma', 'Adobe XD', 'Mobile App Testing'].map(skill => (
                    <div key={skill} style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="mailto:angger@example.com" style={{
                backgroundColor: '#f97316',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '8px',
              ...
              <a href="https://github.com/angger" target="_blank" style={{
              ...
              <a href="https://dribbble.com/angger" target="_blank" style={{
